...
| ------------------ | --------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `adversarial-loop` | Goal, scoped files, specification, symptom, optional caller run, and a clean independent-review completion condition.       | Run bounded independent review/fix rounds, retain source-bound evidence, and stop on structural findings, non-convergence, or unavailable independent coverage.        |
...
| Skill                         | Capability                                                                                                                        |
| ----------------------------- | --------------------------------------------------------------------------------------------------------------------------------- |
| `$codex-rig:adversarial-loop` | Independently challenge and fix a scoped diff through bounded rounds with source-bound closure evidence and explicit stop rules.  |
