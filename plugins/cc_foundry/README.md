...
| `test_check_install_state.py`      | `check_install_state.py`                    | 19    | Nested/flat registry shape resolution, missing registry/foundry/cache-dir severity, settings merge completeness, statusline and allow-list checks, bridge enablement, stale-hook and rule-link staleness, symlink checks, `--check` dispatch                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
